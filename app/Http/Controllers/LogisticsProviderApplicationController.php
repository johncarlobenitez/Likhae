...
class LogisticsProviderApplicationController extends Controller
{
    public function create(Request $request): View|RedirectResponse
    {
        ...
        return view('onboarding.partner-apply', compact('provider'));
    }
    ...
    public function status(Request $request): View|RedirectResponse
    {
        ...
        return view('onboarding.status', ['type' => 'courier company', 'record' => $provider, 'applyRoute' => route('partner.create')]);
    }
}
