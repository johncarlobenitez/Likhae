    ...
    <div class="likhae-container">
        <div class="flex h-[64px] items-center gap-4">
            ...
            <nav class="ml-auto flex items-center gap-1 sm:gap-3">
                ...
                <a href="{{ url('/wishlist') }}" class="buyer-header-action">
                    <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.6">
        ...
        <div class="likhae-container">
            ...
            <div class="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                @foreach($flashDeals as $deal)
                    <a href="{{ url('/buyer/products/' . Str::slug($deal['name'])) }}" class="flash-card group">
                        <img
                            src="{{ $deal['image'] }}"
                            alt="{{ $deal['name'] }}"
    ...
    <section id="featured" class="section-space bg-[#f5f2ed]">
        <div class="likhae-container">
            <div class="section-heading">
                ...
                <a href="{{ url('/buyer/products') }}" class="section-link">View all →</a>
            </div>

            <div class="mt-8 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
                @foreach($products as $product)
                    <article class="product-card group">
                        <a href="{{ url('/buyer/products/' . Str::slug($product['name'])) }}" class="relative block aspect-[4/4.4] overflow-hidden bg-[#ebe7e1]">
                            <img
                                src="{{ $product['image'] }}"
                                alt="{{ $product['name'] }}"
                                class="h-full w-full object-cover transition duration-500 group-hover:scale-105"
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{ url('/buyer/products/' . Str::slug($product['name'])) }}" class="mt-2 block min-h-[40px] text-sm font-medium leading-5 hover:text-[#d92d2f]">
                                {{ $product['name'] }}
                            </a>
            ...
            <div class="mt-8 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
                @foreach($localFinds as $item)
                    <article class="group overflow-hidden bg-white text-[#111]">
                        <a href="{{ url('/buyer/products/' . Str::slug($item['name'])) }}" class="block aspect-square overflow-hidden">
                            <img
                                src="{{ $item['image'] }}"
                                alt="{{ $item['name'] }}"
                                class="h-full w-full object-cover transition duration-500 group-hover:scale-105"
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{ url('/buyer/products/' . Str::slug($item['name'])) }}" class="mt-2 block min-h-[40px] text-sm font-medium leading-5 hover:text-[#d92d2f]">
                                {{ $item['name'] }}
                            </a>
