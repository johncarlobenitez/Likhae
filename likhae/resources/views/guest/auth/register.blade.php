                ...
                >
                    ...
                    <section class="form-section">
                        ...
                        <p class="mt-3 text-xs leading-5 text-[#918a82]">
                            Select your Province, Municipality/City, and Barangay.
                        ...
                        <div class="mt-5 grid gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {{-- Populate from your address API --}}
                                    @if(old('province'))
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @if(old('municipality'))
                                        <option value="{{ old('municipality') }}" selected>
                                            {{ old('municipality') }}
                                        </option>
                                    @endif
                                </select>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @if(old('barangay'))
                                        <option value="{{ old('barangay') }}" selected>
                                            {{ old('barangay') }}
                                        </option>
                                    @endif
                                </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        */
        ...
        | Address API Hooks
        |--------------------------------------------------------------------------
        | These dropdowns are intentionally ready for your Philippine address API.
        |
        | Expected flow:
        |
        | Province
        ...
        | Barangay
        |
        | Wire your API in resources/js/guest/auth/register.js later.
        |--------------------------------------------------------------------------
        */
        ...
        province.addEventListener('change', function () {
            municipality.disabled = !province.value;
