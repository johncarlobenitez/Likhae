...
@php
    ...
    $contactDetails = [
        ...
        ['label' => 'Complete Address', 'value' => data_get($rider, 'address', 'Barangay Real, Calamba City, Laguna'), 'wide' => true],
    ];
...
<style>
    ...
    .rr-actions {
        ...
        border: 1px solid var(--rr-border);
        border-radius: 18px;
        background: color-mix(in srgb, var(--rr-card) 94%, transparent);
    ...
    <section class="rr-profile">
        ...
        <div class="rr-profile-copy">
            ...
            <div class="rr-profile-meta">
                ...
                <span class="rr-profile-chip">
                    {{ data_get($rider, 'area', 'Area Unassigned') }}
                </span>
            </div>
        </div>
    ...
    <section class="rr-card">
        <header class="rr-card-head">
            <div>
                ...
                <p>
                    Vehicle details for courier operations.
                </p>
            </div>
                    ...
                    <div class="rr-document-copy">
                        ...
                        <div>
                            <button
                                ...
                                data-document-preview="{{ $document['key'] }}"
        ...
        <section class="rr-actions">
            ...
            <div class="rr-action-buttons">
                ...
                >
                    ...
                    <button type="submit" class="rr-btn rr-btn-approve">
                        <svg viewBox="0 0 24 24" aria-hidden="true">
                            {!! $icons['check'] !!}
                        </svg>
                ...
                >
                    ...
                    <button type="submit" class="rr-btn rr-btn-reject">
                        <svg viewBox="0 0 24 24" aria-hidden="true">
                            {!! $icons['x'] !!}
                        </svg>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document
        .querySelectorAll('[data-document-preview]')
