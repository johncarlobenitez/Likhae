...
<div class="ra-page">
    ...
    <section class="ra-hero">
        <div>
            ...
            <p>
                Review courier registration requests, verify submitted information,
    ...
    <section class="ra-list-card">
        <header class="ra-list-head">
            <div>
                ...
                <p>
                    Verify applicant information and submitted requirements.
                </p>
            </div>
