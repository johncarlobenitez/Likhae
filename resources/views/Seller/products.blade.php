            ...
            <div class="sl-editor-main">
                <section class="sl-card sl-form-section">
                    ...
                    <div class="sl-form-grid">
                        ...
                        <label class="sl-field"><span>+ Add New Subcategory</span><input name="new_subcategory" value="{{ old('new_subcategory') }}" placeholder="e.g. Oversized T-Shirts"></label>
                        ...
                        <div class="sl-field sl-span-2"><span>Additional images</span><label class="sl-upload-box"><input name="images[]" type="file" accept="image/*" multiple><svg viewBox="0 0 24 24"><path d="M12 16V4M7 9l5-5 5 5M4 15v5h16v-5"/></svg><strong>Upload multiple product images</strong><small>JPG, PNG, WebP - maximum 5 MB each</small></label></div>
                    </div>
                </section>
                ...
                <section class="sl-card sl-form-section">
                    ...
                    <div class="sl-variation-table" data-variation-list>
                        <div class="sl-variation-row sl-variation-labels" aria-hidden="true"><span>Name</span><span>Option</span><span>SKU</span><span>Price</span><span>Stock</span><span></span></div>
