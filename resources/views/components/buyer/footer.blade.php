...
<footer class="lk-ed-footer" role="contentinfo">
    <div class="lk-ed-footer-inner">
        ...
        <div class="lk-ed-footer-col">
            ...
            <a href="{{ route('login') }}">Track Your Order</a>
            <a href="{{ route('login') }}">Returns &amp; Refunds</a>
