...
<div class="flex flex-col gap-6">
    <section>
        ...
        <p class="mt-2 max-w-[680px] text-[11px] leading-6 text-muted">
            {{ $earningsNotice ?? 'No rider payout rule or earnings table is configured yet.' }}
        </p>
    </section>

    <section class="rounded-xl border border-line bg-surface p-6">
        <h2 class="text-[13px] font-semibold text-ink">Earnings Records</h2>
        <p class="mt-1 text-[9px] text-muted">LIKHAE will show earnings here after a real payout calculation is configured.</p>
