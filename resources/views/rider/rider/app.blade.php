...
transition
hover:bg-white/5
{{ request()->routeIs('rider.history.index') ? 'bg-white/8 text-white ring-1 ring-white/10' : 'text-sidebar-muted hover:text-white' }}
"
>
...
<script>
    ...
    document.addEventListener('themechange', (event) => {
        const theme = event.detail?.theme || localStorage.getItem('likhae-theme') || 'light';
