...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/registrations', fn () => view('Admin.registrations', [
        'applications' => collect(), 'type' => 'buyers',
        'counts' => ['buyers'=>0,'sellers'=>0,'logistics'=>0,'riders'=>0],
        'stats' => ['pending'=>0,'approved'=>0,'rejected'=>0],
    ]))->name('registrations');
    Route::post('/registrations/{user}/approve', fn () => back())->name('registrations.approve');
    Route::post('/registrations/{user}/reject', fn () => back())->name('registrations.reject');
    Route::get('/registrations/{user}/documents/{document}', fn () => abort(503))->name('registrations.document');
